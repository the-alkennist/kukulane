    ...
    $(document).ready(function () {
        ...
        function fetchOrders() {
            $.ajax({
                url: 'https://ksdfj-kb97.onrender.com/api/user/orders/', // Update with your API endpoint
                type: 'GET',
                success: function (response) {
                    ...
                    $.each(response, function (index, order) {
                        ...
                        var orderItemHtml = '<div class="cart-item">' +
                            '<h5>' + order.order_items.product_name + '</h5>' +
        ...
        function deleteOrder(orderId) {
            $.ajax({
                url: 'https://ksdfj-kb97.onrender.com/api/user/orders/' + orderId + '/', // Update with your API endpoint
                type: 'DELETE',
                success: function () {
